...
class CouponDetailActivity : AppCompatActivity() {
    ...
    Glide.with(this).load(couponSelected?.image_url).override(520, 520).centerCrop().into(imgHeaderDetail)
    Glide.with(this).load(couponSelected?.image_url).override(520, 520).centerCrop().into(imgCouponDetail)
